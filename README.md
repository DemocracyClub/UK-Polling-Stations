...
```
sudo apt-get install postgresql-14 postgresql-server-dev-all python3-psycopg2 python3-dev postgis postgresql-14-postgis-3 libxml2-dev libxslt1-dev nodejs npm tidy

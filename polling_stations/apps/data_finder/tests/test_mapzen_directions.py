...
from data_finder.helpers.directions import DirectionsException, MapzenDirectionsClient


class MapzenDirectionsClientInvalidMock(MapzenDirectionsClient):
    def get_data(self, url):
        return {"trip": {"status": "oh noes!! terrible things happened :("}}

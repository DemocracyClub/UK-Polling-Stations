...
"""
TODO: make everything a property (that can be)

I think the way to handle this now is copy the API warts and all for now
and then improving it more is a follow up issue
"""

...
class AddressbaseUpdater(BaseUpdater):
    ...
    def get_importer(self):
        # not used since we're implementing run_importer directly
        pass
    ...
    def run_importer(self, cmd):
        ...
        self.cursor.execute(copy_string)
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            with transaction.atomic():
                ...
                # Rename old tables
                addressbase_updater.rename_old_table()
                uprntocouncil_updater.rename_old_table()
            ...
            # Validate foreign keys outside the transaction
            self.stdout.write("Validating foreign key constraints...")
            if addressbase_updater.foreign_key_constraints:
                addressbase_updater.validate_foreign_keys()
            if uprntocouncil_updater.foreign_key_constraints:
                uprntocouncil_updater.validate_foreign_keys()

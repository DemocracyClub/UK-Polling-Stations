...
class Migration(migrations.Migration):
    ...
    dependencies = [("addressbase", "0001_initial")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "uprn",
                    models.CharField(serialize=False, primary_key=True, max_length=12),
                ),
        ...
        migrations.AlterModelOptions(name="address", options={"managed": True}),
    ]

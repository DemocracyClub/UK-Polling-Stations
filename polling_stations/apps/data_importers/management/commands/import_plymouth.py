...
class Command(BaseXpressDemocracyClubCsvImporter):
    council_id = "PLY"
    addresses_name = (
        "2023-05-04/2023-03-29T16:44:17.695108/Democracy_Club__04May2023.tsv"
    )
    stations_name = (
        "2023-05-04/2023-03-29T16:44:17.695108/Democracy_Club__04May2023.tsv"
    )
    ...
    def address_record_to_dict(self, record):
        ...
        if uprn in [
            ...
            "10012058496",  # HARDWICKE LODGE, DRUNKEN BRIDGE HILL, PLYMPTON, PLYMOUTH
            "10091562408",  # 43 PLYMBRIDGE ROAD, PLYMPTON, PLYMOUTH
            "100040489286",  # 180 ST. MARGARETS ROAD, PLYMOUTH

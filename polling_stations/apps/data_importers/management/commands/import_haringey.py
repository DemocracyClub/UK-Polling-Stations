...
class Command(BaseXpressDemocracyClubCsvImporter):
    council_id = "HRY"
    addresses_name = (
        "2026-06-25/2026-05-26T16:07:25.785770/Democracy_Club__25June2026.tsv"
    )
    stations_name = (
        "2026-06-25/2026-05-26T16:07:25.785770/Democracy_Club__25June2026.tsv"
    )
    ...
    # maintaining some exclusions through by-election
    ...
    def address_record_to_dict(self, record):
        ...
        if uprn in [
            "10093592343",  # FLAT D 28 PALMERSTON ROAD, WOOD GREEN, LONDON

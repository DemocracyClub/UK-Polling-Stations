...
class Command(BaseHalaroseCsvImporter):
    ...
    def station_record_to_dict(self, record):
        # The following stations have postcodes that don't match their address in addressbase:
        ...
        # The following stations are only off by one letter so I've commented them out until the council responds:

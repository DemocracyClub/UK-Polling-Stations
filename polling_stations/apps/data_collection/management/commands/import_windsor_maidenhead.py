...
class Command(BaseHalaroseCsvImporter):
    ...
    def address_record_to_dict(self, record):
        ...
        if uprn in [
            "10012336033",  # SL63DU -> SL63HU : FLAT 1 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012335956",  # SL63DU -> SL63HU : FLAT 2 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012335957",  # SL63DU -> SL63HU : FLAT 3 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012335958",  # SL63DU -> SL63HU : FLAT 4 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012335959",  # SL63DU -> SL63HU : FLAT 5 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012335960",  # SL63DU -> SL63HU : FLAT 6 27 MERCIA ROAD, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "100081046115",  # SL63QU -> SL63QP : GORSELANDS HOUSE BURCHETTS GREEN LANE, BURCHETTS GREEN, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012315053",  # SL66QP -> SL66QR : STUDENTS HOSTEL ACCOMMODATION BLOCK 1 BURCHETTS GREEN ROAD, BURCHETTS GREEN, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012326112",  # SL66QP -> SL66QR : STUDENTS HOSTEL ACCOMMODATION BLOCK 2 BURCHETTS GREEN ROAD, BURCHETTS GREEN, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012326113",  # SL66QP -> SL66QR : STUDENTS HOSTEL ACCOMMODATION BLOCK 3 BURCHETTS GREEN ROAD, BURCHETTS GREEN, MAIDENHEAD, WINDSOR AND MAIDENHEAD
            "10012326114",  # SL66QP -> SL66QR : STUDENTS HOSTEL ACCOMMODATION BLOCK 4 BURCHETTS GREEN ROAD, BURCHETTS GREEN, MAIDENHEAD, WINDSOR AND MAIDENHEAD

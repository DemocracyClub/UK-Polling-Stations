...
class Command(BaseHalaroseCsvImporter):
    ...
    addresses_name = "local.2019-05-02/Version 1/polling_station_export-2019-03-05.csv"
    stations_name = "local.2019-05-02/Version 1/polling_station_export-2019-03-05.csv"

...
class Command(BaseXpressDCCsvInconsistentPostcodesImporter):
    ...
    addresses_name = 'local.2018-05-03/Version 1/Democracy_Club__03May2018 Croydon (2).tsv'
    stations_name = 'local.2018-05-03/Version 1/Democracy_Club__03May2018 Croydon (2).tsv'

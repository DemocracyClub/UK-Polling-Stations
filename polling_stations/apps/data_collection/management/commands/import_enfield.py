...
class Command(BaseAddressCsvImporter):
    """
    Imports the Polling Station data from Enfield Council
    """
    council_id      = 'E09000010'
    addresses_name  = 'PropertyPostCodePollingStationWebLookup-2016-06-09.TSV'
    stations_name   = 'PropertyPostCodePollingStationWebLookup-2016-06-09.TSV'
    csv_delimiter   = '\t'
    elections       = [
        'ref.2016-06-23'
    ]

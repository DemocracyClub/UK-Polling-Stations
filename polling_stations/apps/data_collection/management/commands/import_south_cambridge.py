...
class Command(BaseXpressDemocracyClubCsvImporter):
    ...
    addresses_name = "europarl.2019-05-23/Version 1/Democracy_Club__23May2019scambs.tsv"
    stations_name = "europarl.2019-05-23/Version 1/Democracy_Club__23May2019scambs.tsv"
    elections = ["europarl.2019-05-23"]
    csv_delimiter = "\t"

    def station_record_to_dict(self, record):
        if record.polling_place_id == "6803":

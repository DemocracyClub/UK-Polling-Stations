...
class Command(BaseDemocracyCountsCsvImporter):
    ...
    addresses_name  = 'local.2018-05-03/Version 1/Democracy Club - Polling Districts Barnsley.CSV'
    stations_name   = 'local.2018-05-03/Version 1/Democracy Club - Polling Stations Barnsley.CSV'
    elections       = [
        'local.2018-05-03',

...
class XpressDemocracyClubImportTests(TestCase):
    ...
    def test_station_ids(self):
        self.assertEqual('518',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-518-1-abbots-way-lancing-west-sussex-bn159dh')\
                .polling_station_id
        )
        self.assertEqual('518',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-518-2-abbots-way-lancing-west-sussex-bn159dh')\
                .polling_station_id
        )
        self.assertEqual('512',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-512-1-freshbrook-mews-freshbrook-road-lancing-west-sussex-bn158da')\
                .polling_station_id
        )
        self.assertEqual('512',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-512-2-freshbrook-mews-freshbrook-road-lancing-west-sussex-bn158da')\
                .polling_station_id
        )
...
class XpressWebLookupImportTests(TestCase):
    ...
    def test_station_ids(self):
        self.assertEqual('5730',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-5730-189a-balham-high-road-sw129be')\
                .polling_station_id
        )
        self.assertEqual('5730',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-5730-189-balham-high-road-sw129be')\
                .polling_station_id
        )
        self.assertEqual('5736',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-5736-200-balham-high-road-sw177be')\
                .polling_station_id
        )
        self.assertEqual('5736',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-5736-balham-high-road-sw177be')\
                .polling_station_id
        )

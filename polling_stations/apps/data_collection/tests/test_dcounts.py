...
class DemocracyCountsImportTests(TestCase):
    ...
    def test_station_ids(self):
        self.assertEqual('B6/1',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-b6-1-158-wood-street-barnet-en54db')\
                .polling_station_id
        )
        self.assertEqual('B6/1',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-b6-1-164-wood-street-barnet-en54db')\
                .polling_station_id
        )
        self.assertEqual('B60/1',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-b60-1-flat-1-196-ballards-lane-finchley-london-n32na')\
                .polling_station_id
        )
        self.assertEqual('B60/1',
            ResidentialAddress\
                .objects\
                .get(slug='x01000000-b60-1-flat-3-196-ballards-lane-finchley-london-n32na')\
                .polling_station_id
        )

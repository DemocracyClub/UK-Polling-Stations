...
echo "wal_receiver_timeout = 12000" | sudo tee -a /etc/postgresql/14/main/postgresql.conf
...
echo "primary_slot_name = ${SUBSCRIPTION}" | sudo tee -a /etc/postgresql/14/main/postgresql.conf
